...
public class PlayerInfo extends JPanel{
	...
	private void drawPlayer(Graphics g, PlayerModel player, int y) {
		...
		g.drawImage(str, 44+130, y+40, 44+130+str.getWidth(null), y+40+str.getHeight(null),
				0, 0, str.getWidth(null), str.getHeight(null), null);
		g.drawImage(h5, 44, y+40-14, 44+h5.getWidth(null), y+40-14+h5.getHeight(null),
				0, 0, h5.getWidth(null), h5.getHeight(null), null);
		g.setFont(new Font(null,1,16));//设置字体
		...
		if(cash <= 0) {
			cPosX -= 70;
			g.drawImage(none, cPosX, cPosY, cPosX+none.getWidth(null), cPosY+none.getHeight(null),
					0, 0, none.getWidth(null), none.getHeight(null), null);
		}
		while((int)cash >0) {
			int num = cash%10;
			g.drawImage(numberIMG[num], cPosX, cPosY, cPosX+numberIMG[num].getWidth(null),
					cPosY+ numberIMG[num].getHeight(null), 0, 0, numberIMG[num].getWidth(null),
					numberIMG[num].getHeight(null), null);
			cash /= 10;
			cPosX -= 16;
		}
		int nx = player.getNx();
		...
		if(nx <= 0) {
			nPosX -= 70;
			g.drawImage(none, nPosX, nPosY, nPosX+none.getWidth(null),
					nPosY+none.getHeight(null),
					0, 0, none.getWidth(null), none.getHeight(null), null);
		}
		while((int)nx > 0) {
			int num = nx %10;
			g.drawImage(numberIMG[num], nPosX, nPosY,nPosX+numberIMG[num].getWidth(null),
					nPosY+numberIMG[num].getHeight(null),
					0,0,numberIMG[num].getWidth(null),
					numberIMG[num].getHeight(null),null);
			nx /= 10;
			nPosX -= 16;		
		}
		...
		if(buildings <= 0) {
			bPosX -= 70;
			g.drawImage(none, bPosX, bPosY, bPosX +none.getWidth(null),
					bPosY + none.getHeight(null), 0,0,none.getWidth(null),
					none.getHeight(null),null);
		}
		while ((int )buildings > 0){
			int num = buildings % 10;
			g.drawImage(numberIMG[num], bPosX,bPosY,
					bPosX + numberIMG[num].getWidth(null),
					bPosY + numberIMG[num].getHeight(null),
					0,0,numberIMG[num].getWidth(null),
					numberIMG[num].getHeight(null),null);
			buildings /= 10;
			bPosX -= 16;
		}
		g.drawImage(out, 44 + 130 + 187, y + 40 - 28,
				44 + 130 + 187 + out.getWidth(null),
				y + 40 - 28 + out.getHeight(null),
				0, 0, out.getWidth(null), out.getHeight(null), null);
	}

...
public class FrameConfig extends JFrame{
	...
	private JPanel createMapSelectPanel() {
		...
		jp.setLayout(new GridLayout()); //网格布局
		jp.setBackground(new Color(235,236,237));
		JPanel lPane = new JPanel(new BorderLayout());
		String[] maps = { "\"学园都市\"", "\"圣西罗球场\"", "\"终末之谷\"" };
		final ImageIcon[] maps1 = {
				new ImageIcon("images/other/1.jpg"),
				new ImageIcon("images/other/2.jpg"),
				new ImageIcon("images/other/3.jpg") };
